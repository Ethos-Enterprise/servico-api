...
public record ServicoResponse(UUID id, String nomeServico, String descricao, Double valor, List<AreaAtuacaoEsgEnum> areaAtuacaoEsg, UUID fkPrestadoraServico) {
